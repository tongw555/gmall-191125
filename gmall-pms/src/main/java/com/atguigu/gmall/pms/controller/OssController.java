...
public class OssController {
    ...
    String accessId = "LTAI4GAkG17wBZCrs8GMPh48"; // 请填写您的AccessKeyId。
    String accessKey = "hVqAHjIq19x6olsB6oK8amBFXAjmgr"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "ggmall-191125"; // 请填写您的 bucketname 。
